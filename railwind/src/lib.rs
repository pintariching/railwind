...
impl BackgroundsConfig {
    ...
    pub fn get_color(&self) -> &HashMap<&'static str, &'static str> {
        self.color
            .get_or_init(|| ron::from_str(include_str!("config/colors.ron")).unwrap())
    }

    pub fn get_mut_color(&mut self) -> &mut HashMap<&'static str, &'static str> {
        let _ = self.get_color();
        self.color.get_mut().unwrap()
    }

    pub fn get_position(&self) -> &HashMap<&'static str, &'static str> {
        self.position
            .get_or_init(|| ron::from_str(include_str!("config/background_position.ron")).unwrap())
    }

    pub fn get_mut_position(&mut self) -> &mut HashMap<&'static str, &'static str> {
        let _ = self.get_position();
        self.position.get_mut().unwrap()
    }

    pub fn get_size(&self) -> &HashMap<&'static str, &'static str> {
        self.size
            .get_or_init(|| ron::from_str(include_str!("config/background_size.ron")).unwrap())
    }

    pub fn get_mut_size(&mut self) -> &mut HashMap<&'static str, &'static str> {
        let _ = self.get_size();
        self.size.get_mut().unwrap()
    }

    pub fn get_image(&self) -> &HashMap<&'static str, &'static str> {
        self.image
            .get_or_init(|| ron::from_str(include_str!("config/background_image.ron")).unwrap())
    }

    pub fn get_mut_image(&mut self) -> &mut HashMap<&'static str, &'static str> {
        let _ = self.get_image();
        self.image.get_mut().unwrap()
    }

    pub fn get_gradient_color_stops(&self) -> &HashMap<&'static str, &'static str> {
        self.gradient_color_stops
            .get_or_init(|| ron::from_str(include_str!("config/colors.ron")).unwrap())
    }

    pub fn get_mut_gradient_color_stops(&mut self) -> &mut HashMap<&'static str, &'static str> {
        let _ = self.get_gradient_color_stops();
        self.gradient_color_stops.get_mut().unwrap()
    }
}
...
impl SpacingConfig {
    ...
    pub fn get_padding(&self) -> &HashMap<&'static str, &'static str> {
        self.padding
            .get_or_init(|| ron::from_str(include_str!("config/padding.ron")).unwrap())
    }

    pub fn get_mut_padding(&mut self) -> &mut HashMap<&'static str, &'static str> {
        let _ = self.get_padding();
        self.padding.get_mut().unwrap()
    }

    pub fn get_margin(&self) -> &HashMap<&'static str, &'static str> {
        self.margin
            .get_or_init(|| ron::from_str(include_str!("config/margin.ron")).unwrap())
    }

    pub fn get_mut_margin(&mut self) -> &mut HashMap<&'static str, &'static str> {
        let _ = self.get_margin();
        self.margin.get_mut().unwrap()
    }

    pub fn get_space_between(&self) -> &HashMap<&'static str, &'static str> {
        self.space_between
            .get_or_init(|| ron::from_str(include_str!("config/space_between.ron")).unwrap())
    }

    pub fn get_mut_space_between(&mut self) -> &mut HashMap<&'static str, &'static str> {
        let _ = self.get_space_between();
        self.space_between.get_mut().unwrap()
    }
}
...
//     pub fn new(raw_class_name: &'a str, states: Vec<State>, position: Position) -> Self {
//         Self {
//             raw_class_name,
...
//                     return Ok(Self::new(raw_class, vec![], position.clone()));
//                 }
//             }
